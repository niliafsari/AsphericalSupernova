...
plot(log10(time_ic(23:32)),log10(t_color_bsg(1,23:32)*30/11604.52),'k','LineWidth',2); hold on
plot(log10(time_ic(23:32)),log10(T_c),'--k','LineWidth',2);
xlabel('Log (t [sec])'); 
ylabel('Log (T_{color} [eV])');
legend('Total','Spherical')
%title(['BSG model at t=' num2str(time.time1(t)*tconv,3) ' (sec)']);
set(gca,'LineWidth',1.5,'FontSize',12);
name=['/home/nilou/Data/plot/colortempic_f.pdf'];
print('-dpdf',name) 
export_fig(name, '-pdf')
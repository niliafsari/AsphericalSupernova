...
%     end
    ...
    [C,~]=contour3(xx,yy,diff_frontBSG,[1 1],'LineColor','b','Linewidth',0.3);hold on     
    rdiff=sqrt(C(1,2:length(C)).^2+C(2,2:length(C)).^2);
    xdiff=C(1,2:length(C));
    ydiff=C(2,2:length(C)); 
...
save('/home/nilou/Data/luminosity_ic_v2.mat', 'luminosity')

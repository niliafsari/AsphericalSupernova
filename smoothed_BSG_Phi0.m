...
%    close all
    ...
    axis equal
    axis([0 4 0 4])
    name=['/home/nilou/Data/plot/BSGdiff/BSG_filter_smoothed_Phi0' num2str(t) '.png'];
    print(gcf, '-dpng', '-r50', name)
    export_fig(name, '-dpng', '-r50')
end
save('/home/nilou/Data/processeddata/BSG/luminosity_smoothedk55_Phi0.mat','luminosity')

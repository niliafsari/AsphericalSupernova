...
%     view(2); 
%     name=['/home/nilou/Data/plot/BSGdiff/DiffFrontBSG_smoothed_' num2str(t) '.png'];
%     print(gcf, '-dpng', '-r100', name)
%     export_fig(name, '-dpng', '-r100')
     save(['/home/nilou/Data/processeddata/BSG/diff_bsg_smoothed_k55_temp' num2str(t) '.mat'], 'diff_bsg') 
end

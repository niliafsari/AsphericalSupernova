...
t_color_phi0=t_color.t_color_phi0;
for t=23:50
    a=7.566e-15;
    t
    radius=zeros(1,2048);
    name=['/home/nilou/Data/processeddata/RSG/tauRSGradial_' int2str(t-1) '.csv'] ;
    tau= csvread(name);
    nameff=['/home/nilou/Data/processeddata/RSG/tauRSGradialFF_' int2str(t-1) '.csv'] ;
    ...
    diff_bsg1=load(['/home/nilou/Data/processeddata/RSG/diff_rsg_smoothed55_' num2str(t) '.mat']);
    ...
    name=['/home/nilou/Data/plot/RSGdiff/colortempContourWdiff_' int2str(t)];
    print('-dpng',name) 
    export_fig(name, '-png')
end
save('/home/nilou/Data/processeddata/RSG/colortemp_tot_v3.mat','t_color_tot')
save('/home/nilou/Data/processeddata/RSG/colortemp_phi0_v3.mat','t_color_phi0')
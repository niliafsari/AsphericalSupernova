...
%     scatter(xdiff(index_k)*2/rconv,ydiff(index_k)*2/rconv,3,'g'); hold on
    ...
    axis equal
    axis([0 4 0 4])
    name=['/home/nilou/Data/plot/icdiff/ic_filter_smoothed_phi90_' num2str(t) '.png'];
    print(gcf, '-dpng', '-r50', name)
    export_fig(name, '-dpng', '-r50')

end
save('/home/nilou/Data/processeddata/ic/luminosity_smoothed_ic_phi90.mat','luminosity')

...
for t=26:26
    radius=zeros(1,2048);
    name=['/home/nilou/Data/processeddata/ic/tauIcradial_v2_' int2str(t) '.csv'] ;
    tau= csvread(name);
    nameff=['/home/nilou/Data/processeddata/ic/tauIcradialFF_v2_' int2str(t) '.csv'] ;
    tauff= csvread(name);
...
%     caxis auto
   ...
   % p3=plot(x,y,'r','Linewidth',1); hold on
    C=contour(xx,yy,tau,[1 1],'LineColor','c','Linewidth',2)
    hold on  
    axis equal 
    ...
    name=['/home/nilou/Data/plot/icdiff/tauIcContourWdiff_v1_' int2str(t)];
    print('-dpng',name) 
    export_fig(name, '-png')
end
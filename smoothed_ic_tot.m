...
for t=23:32
    ...
    luminosity(1,t)=dot(factor,flux1);
...
%     scatter(xdiff(index_k)*2/rconv,ydiff(index_k)*2/rconv,3,'g'); hold on
    ...
    axis equal
    axis([0 4 0 4])
    name=['/home/nilou/Data/plot/icdiff/ic_filter_smoothed_new_' num2str(t) '.png'];
    print(gcf, '-dpng', '-r50', name)
    export_fig(name, '-dpng', '-r50')

end
save('/home/nilou/Data/processeddata/ic/luminosity_smoothed_ictot.mat','luminosity')

...
for i=0:0
    ...
    save(['/home/nilou/Data/rawdata_075/density/dens' int2str(cell) '_' int2str(i) '.mat'],'dens_data');
    save(['/home/nilou/Data/rawdata_075/pressure/pres' int2str(cell) '_' int2str(i) '.mat'],'pres_data');
    save(['/home/nilou/Data/rawdata_075/velocity/velr' int2str(cell) '_' int2str(i) '.mat'],'velx_data');
    save(['/home/nilou/Data/rawdata_075/gfunction/gfun' int2str(cell) '_' int2str(i) '.mat'],'gfun_data');
    save(['/home/nilou/Data/rawdata_075/velocity/velth' int2str(cell) '_' int2str(i) '.mat'],'vely_data');
end 

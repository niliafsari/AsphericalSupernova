...
%f = fit(log10(time_rsg(23:50)),log10(4*luminosityRSG.luminosity(23:50))','gauss6')
plot(tt(23:50),log10(2*luminosityRSG.luminosity(23:50))','r'),hold on,
 %set(h,'MarkerSize',3.5,'color','r');
 
 %luminosityBSG.luminosity(22)=10^42.5;
 %f = fit(log10(time_bsg(23:41)),log10(4*luminosityBSG.luminosity(23:41))','gauss5')
plot(tt(23:41),log10(2*luminosityBSG.luminosity(23:41))','b'),hold on,
%set(h1,'MarkerSize',8,'color','b');
 
 %f = fit(log10(tt(23:35)),log10(4*luminosityIc.luminosity(23:35))','gauss3')
plot(tt(23:34),log10(2*luminosityIc.luminosity(23:34))','k'),hold on,
...
legend('RSG', 'BSG','Ic','Location','northeast');
set(gca,'LineWidth',1.5,'FontSize',10);
name=['/home/nilou/Data/totlumall_time.pdf'];
print('-dpdf',name) 
export_fig(name, '-pdf')
